...
static inline void nativePush(){} // just a base case ladies
...
//Thank god for C++17 Language Standard else I'd probably do a extensive rewrite just for varadic arguments
